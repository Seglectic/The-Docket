...
export const els = {
  ...
  spinActiveGameContent: document.getElementById("spin-active-game-content"),
  ...
  gameStatusActive: document.getElementById("game-status-active"),
  ...
  debugViewersChoiceButton: document.getElementById("debug-viewers-choice-button"),
  ...
  launchEnergy: document.getElementById("launch-energy"),
  friction: document.getElementById("friction"),
  suspense: document.getElementById("suspense"),
  launchEnergyOutput: document.getElementById("launch-energy-output"),
  frictionOutput: document.getElementById("friction-output"),
  suspenseOutput: document.getElementById("suspense-output"),
};
